                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="dropdown mt-4 mt-sm-0">
                                            <a class="btn btn-light dropdown-toggle" href="#" id="dropdownMenuLink1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Dropdown link
                                                <i class="mdi mdi-chevron-down"></i>
                                            </a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex gap-2 flex-wrap">
                                    ...
                                    <div class="btn-group dropend">
                                        <button type="button" class="btn btn-light waves-effect waves-light dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="btn-group dropend">
                                        ...
                                        <button type="button" class="btn btn-light waves-effect waves-light dropdown-toggle-split dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
